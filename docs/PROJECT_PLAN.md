...
| TBD | Phase 3 (visual/portfolio polish), Phase 4 sub-projects 4D→4F→4G, and 4C's deferred cross-posting/demo-asset-regen scope once the relevant developer apps are registered |
